...
| CRM-кабинет | Работает | Yandex Cloud Function, вход по паролю, две YDB, ручные клиенты и заметки |
...
`crmDatabasesConfigured: 2`; авторизованный кабинет показал новую синтетическую заявку бизнес-сайта
с устройством «Компьютер» и ОС «Windows» после автоматического расширения основной YDB.
...
flowchart LR
    ...
    F -->|Статусы и заметки интерьерных заявок| CI
```
...
- Активная CRM-версия: `d4etormdff56pbaocbci`
