...
Обновление 11.09.2026: персональные данные заявки сначала сохраняются в YDB Serverless `ru-central1`. Cloudflare и Telegram получают только ID заявки и служебное время. В Telegram добавлена кнопка `Открыть заявку`, которая ведёт в защищённый мобильный кабинет Yandex Function. Полная переносимая схема и инструкция для других сайтов: [UNIVERSAL-RUSSIA-LEADS-DEPLOYMENT.md](UNIVERSAL-RUSSIA-LEADS-DEPLOYMENT.md).
