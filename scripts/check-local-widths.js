async page => {
 const results={};
 for(const width of [360,375,390,430,768,1024,1200,1920]) {
 ...
 for(const rec of data.sections){
  if(rec.height<1||rec.id==='header'||(![390,768].includes(width)&&!['hero','inquiry','pricing-content','office-content','about'].includes(rec.id)))continue;
